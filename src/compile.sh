...
# Step 2: tsv to opf
python tab2opf/tab2opf.py -s eo -t en ../Combined_Esperanto_English.tsv
...
awk -f metadata.awk Combined_Esperanto_English.opf | sed 's/Combined_//g' > Esperanto_English.opf
